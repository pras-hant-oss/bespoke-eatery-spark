...
function Index() {
  ...
  return (
    <main className="overflow-hidden bg-background text-foreground">
      ...
      <section id="visit" className="grid bg-card lg:grid-cols-2"><iframe title="Map to Tibetan and Nepali Kitchen" loading="lazy" className="min-h-[480px] w-full" src="https://www.google.com/maps?q=27.7147318,85.3101005&z=17&output=embed"/><div className="px-6 py-20 md:px-16 lg:px-20 lg:py-24"><p className="text-xs font-bold uppercase tracking-[0.25em] text-primary">Come share our table</p><h2 className="mt-4 text-5xl font-semibold md:text-7xl">Visit us</h2><div className="mt-10 space-y-8 border-y border-border py-9"><div className="flex gap-5"><MapPin className="mt-1 text-primary"/><div><strong>In the heart of Kathmandu</strong><p className="mt-1 text-sm text-muted-foreground">P876+V2X, Kathmandu 44600, Nepal</p></div></div><div className="flex gap-5"><Clock className="mt-1 text-primary"/><div><strong>Open every day</strong><p className="mt-1 text-sm text-muted-foreground">9:00 AM – 11:00 PM</p></div></div><div className="flex gap-5"><Phone className="mt-1 text-primary"/><div><strong>Call for a table</strong><p className="mt-1 text-sm text-muted-foreground">+977 984-1451986</p></div></div></div><div className="mt-9 flex flex-wrap gap-4"><Button href={mapUrl} target="_blank" rel="noreferrer">Get directions</Button><Button href={phoneUrl} variant="outline">Call restaurant</Button></div></div></section>
